				...
				if (flashInstalled) {
					...
					if (!settings.queueID) {
						var $queue = $('<div />', {
							...
							'class' : 'uploadify-queue clearfix'
						});
		...
		onSelect : function(file) {
			...
			if (settings.itemTemplate == false) {
				settings.itemTemplate = '<div id="${fileID}" class="uploadify-queue-item">\
					...
					<img src="此处打算放图片" width="100%" height="100">\
					<div class="fileName" style="overflow: hidden;">${fileName}</div>\
					<div class="clearfix"><span class="float-l">(${fileSize})</span><span class="data float-r"></span></div>\
