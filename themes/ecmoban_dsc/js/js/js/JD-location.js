...
var provinceHtml = '<div class="content"><div data-widget="tabs" class="m JD-stock" id="JD-stock">'
								...
								+'        <li data-index="0" data-widget="tab-item" class="curr"><a href="#none" class="hover"><em>请选择</em><i class="icon-down"></i></a></li>'

								+'        <li data-index="1" data-widget="tab-item" style="display:none;"><a href="#none" class=""><em>请选择</em><i class="icon-down"></i></a></li>'

								+'        <li data-index="2" data-widget="tab-item" style="display:none;"><a href="#none" class=""><em>请选择</em><i class="icon-down"></i></a></li>'

								+'        <li data-index="3" data-widget="tab-item" style="display:none;"><a href="#none" class=""><em>请选择</em><i class="icon-down"></i></a></li>'
								...
								+'</div><div class="foot">商品暂时只支持配送至中国大陆地区</div></div>';

function getAreaList(result){

	var html = ["<ul class='area-list clearfix'>"];
...
function CurrentAreaInfoInit(){
	...
	ipLoc = ipLoc?ipLoc.split("-"):[15,1213,0,0]; //此处数组是默认地址  如: 15是省的ID,1213是市的ID，最后的县级区域好像可以自动选择

	if(ipLoc.length>0&&ipLoc[0]){

		currentAreaInfo.currentProvinceId = ipLoc[0];

		currentAreaInfo.currentProvinceName = getNameById(ipLoc[1]);
...
$('#store-selector').on("mouseleave",function() {
